...
const (
	SmsService_Send_FullMethodName = "/plugin.v1.SmsService/Send"
)
...
func (c *smsServiceClient) Send(ctx context.Context, in *SendSmsRequest, opts ...grpc.CallOption) (*SendSmsResponse, error) {
...
func (UnimplementedSmsServiceServer) Send(context.Context, *SendSmsRequest) (*SendSmsResponse, error) {
...
var SmsService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "plugin.v1.SmsService",
